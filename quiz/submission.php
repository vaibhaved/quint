<?php
	...
	{
			$query1="SELECT Score FROM users WHERE te_No='".$te_no."'";
			...
			else
			{
				...
				$ip=get_ip_address();
				$query4="INSERT INTO submission (te_no,que_id,ans,ip) VALUES ('".$te_no."','".$score."','".$ans."','".$ip."')";
				...
				if($ans == $ans1 || $ans==$ans2 || $ans == $ans3 || $ans==$ans4 || $ans==$ans5)
				{
					...
					$query3="UPDATE users SET Score='".$score."',Time=NOW() WHERE te_no='".$te_no."'";
